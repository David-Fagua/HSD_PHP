...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../../assets/css/Rventas.css">
</head>
<body>
...
<button class="btn btn-primary" role="link" onclick="window.location='Registrar.php'">Registrar Salida del Producto Vendido</button>
