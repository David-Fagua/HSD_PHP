...
<h2 class="featurette-heading">Hilo X</h2>
        ...
        <a href="Reservar.php" style="float:right;" class="btn btn-primary btn-lg" role="button">Añadir al Carrito</a>
        <a href="Reservar.php" style="float:right;" class="btn btn-primary btn-lg" role="button">Ver mas productos</a>
      </div>
    </div>
  </div>
</div>
